...
<body>
	<div id="content">
		...
		*/
		...
		$lineChart->set('data', array(array(2, 10, 16, 30, 42), array(42, 30, 16, 10, 2)));
		$lineChart->set('legend', array('01/01', '01/02', '01/03', '01/04', '01/05'));
		// We don't to use the x-axis for the legend so we specify the name of each dataset
		$lineChart->set('legendData', array('Annie', 'Marc'));
